    ...
    <div className="flex flex-col items-end gap-1 shrink-0 text-xs text-slate-500">
      ...
      {activePlaylistName && (
        <button
          ...
          className={cx(
            'mt-1 max-w-24 rounded border px-2 py-1 text-[11px] font-medium transition cursor-pointer focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-violet-400',
            isInActivePlaylist
